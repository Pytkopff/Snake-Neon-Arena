            ...
            >
                ...
                >
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={onShare}
                            className={`flex-1 py-3 rounded-xl font-bold text-sm border transition-all flex items-center justify-center gap-2 ${isNewRecord ? 'bg-purple-600 border-purple-400 text-white animate-pulse shadow-[0_0_15px_rgba(168,85,247,0.5)]' : 'bg-transparent border-white/10 text-gray-300 hover:bg-white/5'}`}
                        >
                            Share
                        </button>
                    </div>
