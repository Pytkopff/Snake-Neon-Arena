        ...
        <div className="flex-1 flex flex-col min-h-0 bg-black/80 backdrop-blur-xl rounded-xl border border-white/10 overflow-hidden relative shadow-2xl">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 w-full">
                            ...
                            <button
                                ...
                                className="w-full py-3 rounded-xl bg-green-500 text-black font-black tracking-widest hover:scale-105 transition-all"
                            >
                                AWESOME!
                            </button>
                        </div>
            ...
            <div className="flex border-b border-white/10 shrink-0 bg-white/5">
                <button
                    ...
                    className={`flex-1 py-4 text-sm font-bold uppercase tracking-wider transition-colors relative ${activeTab === 'skins' ? 'text-neon-blue' : 'text-gray-500 hover:text-gray-300'}`}
                >
                    Skins
                ...
                <button
                    ...
                    className={`flex-1 py-4 text-sm font-bold uppercase tracking-wider transition-colors relative ${activeTab === 'missions' ? 'text-yellow-400' : 'text-gray-500 hover:text-gray-300'}`}
                >
                    Missions
                        ...
                        {SKINS.map(skin => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-3 rounded-xl border flex items-center justify-between transition-all group relative overflow-hidden ${isSelected ? 'bg-neon-blue/10 border-neon-blue/50 shadow-[0_0_15px_rgba(0,240,255,0.15)]' : 'bg-white/5 border-white/5 hover:bg-white/10'} ${!isUnlocked && 'opacity-60 grayscale'}`}
                                >
